...
const Moviepage = () => {
  return (
    <>
      <MovieHero />
      <div className="my-12 container px-4 lg:w-1/2 ml-44">
        ...
        <button onClick={launchRazorPay} className="mt-4 bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-8 rounded">
          Book Tickets
        </button>
      </div>
    </>
